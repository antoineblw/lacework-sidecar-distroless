#!/shared/bin/sh
# Copyright 2014-2020 Lacework Inc.
#
...
#    1. sudo sh -c /var/lib/lacework-backup/lacework-sidecar.sh -a ACCESS_TOKEN
#    or
#    1. export LaceworkAccessToken="ACCESS_TOKEN"
#    2. sudo sh -c /var/lib/lacework-backup/lacework-sidecar.sh
#

STRICT_MODE=no
# Agent version
version=3.6.3
dc_sha1=cca2d5b331b1670d4a482a743c5619ef157ea698
dc_musl_sha1=1eb35425998fb5ab0f32aa1771d22f37ef81f903
dc_arm64_sha1=
